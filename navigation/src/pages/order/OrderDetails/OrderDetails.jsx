...
const OrderDetails = () => {
  return (
    ...
    <div className="order-item">
      <img src={classic_matchabara_cold_brew_Pic} alt="Classic Matchabara Cold Brew" className="product-image" /> 
    ...
    {/* ORDER NOTE */}
      ...
      {/* ITEM 2 */}
      <div className="order-item">
        <img src={classic_coffeebara_cold_brew_Pic} alt="Classic Coffeebara Cold Brew" className="product-image" />
    ...
    <div className="customer-info">
        ...
        <div className="info-row">
          <img src={contactIcon} alt="Contact Icon" className="icon-image" />
